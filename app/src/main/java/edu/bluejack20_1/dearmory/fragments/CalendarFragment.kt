...
//        val time = LocalDateTime.now().format(DateTimeFormatter.ofPattern("HH:mm")) as LocalDateTime
//        var dialogFragment: TimePickerDialogFragment
//        dialogFragment = TimePickerDialogFragment(time.hour, time.minute)
//        dialogFragment.show(activity?.supportFragmentManager!!, "timePicker")
//        dialogFragment.setListener(object : TimePickerDialogFragment.TimePickerDialogListener {
//            @SuppressLint("SetTextI18n")
